...
function SidebarProvider({
  ...
  return (
    <SidebarContext.Provider value={contextValue}>
      <div
        data-slot="sidebar-wrapper animate-sidebar-in"
        style={
          {
...
function Sidebar({
  ...
  return (
    <div
      className="group peer hidden text-sidebar-foreground md:block animate-sidebar-in"
      data-state={state}
...
function SidebarContent({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "scrollbar-hover flex min-h-0 flex-1 flex-col gap-0 overflow-auto group-data-[collapsible=icon]:overflow-hidden",
        className,
      )}
      {...props}
    />
