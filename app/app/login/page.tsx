...
export default function LoginPage() {
  ...
  return (
    <div className="relative flex min-h-screen overflow-hidden">
      ...
      <div className="relative z-10 flex-1 flex items-center justify-center p-4 lg:p-8 bg-white/80 dark:bg-zinc-900/80 backdrop-blur-xl border-r border-black/5 dark:border-white/10">
